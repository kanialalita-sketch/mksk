...
\def\type{Perancangan Sistem Prediktif untuk Mitigasi Risiko Pelanggaran \textit{Service Level Agreement} (SLA) pada Operasi Multi-SLA \textit{Third Party Logistics} (3PL)}
%
...
\def\penulisSatu{Kania Lalita Krisnanto} % nama lengkap penulis pertama
...
\def\npmSatu{2506576254} % NPM penulis pertama
...
\def\programSatu{Magister Teknologi Informasi} % program studi penulis pertama
...
\def\gelar{Magister Teknologi Informasi}
%
